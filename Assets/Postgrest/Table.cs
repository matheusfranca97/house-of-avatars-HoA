...
namespace Supabase.Postgrest
{
    ...
    public class Table<TModel> : IPostgrestTable<TModel> where TModel : BaseModel, new()
    {
        ...
        public Task Delete(QueryOptions? options = null, CancellationToken cancellationToken = default)
        {
            ...
            _method = UnityWebRequest.kHttpVerbDELETE;
        ...
        {
            _method = UnityWebRequest.kHttpVerbHEAD;
            ...
            var countStr = response.Headers["Content-Range"];
        ...
        public string GenerateUrl()
        {
            ...
            if (_references.Count > 0)
            {
                ...
                {
                    if ((_method == UnityWebRequest.kHttpVerbGET && !reference.IncludeInQuery) ||
                        (_method == UnityWebRequest.kHttpVerbPOST && reference.IgnoreOnInsert) ||
                        (_method == UnityWebRequest.kHttpVerbPOST && reference.IgnoreOnUpdate)) continue;
        ...
        private Task<BaseResponse> Send(string method, object? data, Dictionary<string, string>? headers = null,
        ...
        private Task<ModeledResponse<TU>> Send<TU>(string method, object? data,
